...
#define FRAME_C_RR0 (char)0x05				//Campo de controlo para trama RR com Nr = 0
#define FRAME_C_RR1	(char)0x85				//Campo de controlo para trama RR com Nr = 1
#define FRAME_C_REJ0	(char)0x01			//Campo de controlo para trama REJ com Nr = 0
#define FRAME_C_REJ1	(char)0x81			//Campo de controlo para trama REJ com Nr = 1
